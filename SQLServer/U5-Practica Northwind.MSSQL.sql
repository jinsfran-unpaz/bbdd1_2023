...
/* 15 */
SELECT TOP 7 ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice, UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued
FROM Products
WHERE UnitsInStock > 0
ORDER BY UnitPrice DESC;

/* 16 */
SELECT TOP 9 ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice, UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued
FROM Products
...
/* 22 */
SELECT TOP 15 WITH TIES ProductID
FROM [Order Details]
GROUP BY ProductID
